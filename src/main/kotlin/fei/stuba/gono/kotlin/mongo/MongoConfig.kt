...
class MongoConfig {
    /***
     * Adds custom converters to Mongo for converting Java Classes that are unable to be serialized / de-serialized by MongoDB
     ...
     * @return Inštancia triedy MongoCustomConvertions vytvorená zoznamom vlastných MongoDB prevodníkov.
